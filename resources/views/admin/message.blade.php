                                        ...
                                        <div class="row align-items-center flex-fill">
                                            ...
                                            <div class="col text-body">
                                                ...
                                                <div class="text-secondary text-truncate w-100">I noticed you added some
                                                    new dependencies in the <code>package.json</code>. Did you also update
                                                    the <code>README</code> with the setup instructions?</div>
                                            </div>
                                        </div>
                                    </a>
                                    <a href="#chat-1" class="nav-link text-start mw-100 p-3" id="chat-1-tab"
                                        ...
                                        <div class="row align-items-center flex-fill">
                                            ...
                                            <div class="col text-body">
                                                ...
                                                <div class="text-secondary text-truncate w-100">I see a couple of edge
                                                    cases we might not be handling in the <code>calculateStatistic</code>
                                                    function. Should I open an issue for that?</div>
                                            </div>
                                        </div>
                                    </a>
                                    <a href="#chat-1" class="nav-link text-start mw-100 p-3" id="chat-1-tab"
                                        ...
                                        <div class="row align-items-center flex-fill">
                                            ...
                                            <div class="col text-body">
                                                ...
                                                <div class="text-secondary text-truncate w-100">Yes, Bob. Please do. We
                                                    should not forget to handle those.</div>
                                            </div>
                                        </div>
                                    </a>
                                    <a href="#chat-1" class="nav-link text-start mw-100 p-3" id="chat-1-tab"
                                        ...
                                        <div class="row align-items-center flex-fill">
                                            ...
                                            <div class="col text-body">
                                                ...
                                                <div class="text-secondary text-truncate w-100">Alright, once the
                                                    <code>README</code> is updated, I'll merge this commit into the main
                                                    branch. Nice work, Paweł.</div>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                                    ...
                                                    <div class="chat-bubble">
                                                        ...
                                                        <div class="chat-bubble-body">
                                                            <p>I noticed you added some new dependencies in the
                                                                ...
                                                                <code>README</code> with the setup instructions?</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row align-items-end justify-content-end">
                                                <div class="col col-lg-6">
                                                    <div class="chat-bubble chat-bubble-me">
                                                        ...
                                                        <div class="chat-bubble-body">
                                                            <p>Yes, Bob. Please do. We should not forget to handle those.
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row align-items-end">
                                                ...
                                                <div class="col col-lg-6">
                                                    <div class="chat-bubble">
                                                        ...
                                                        <div class="chat-bubble-body">
                                                            <p>Alright, once the <code>README</code> is updated, I'll merge
                                                                this commit into the main branch. Nice work, Paweł.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

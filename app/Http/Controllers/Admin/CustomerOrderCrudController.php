...
class CustomerOrderCrudController extends CrudController
{
    ...
    protected function setupListOperation()
    {
        ...
        // ->select('orders.*', 'products.name as product_name', 'addresses.address as address', 'users.name as user_name');

        // Other setup code...


        // $this->crud->query = $this->crud->query
        // ->addSelect('orders.*', 'products.name as product_name', 'addresses.address as address', 'users.name as user_name')
        // ->addSelect(DB::raw("(SELECT SUM(quantity) FROM order_details WHERE order_details.order_id = orders.id) as total_quantity"))
        // ->join('products', 'orders.product_id', '=', 'products.id')
        // ->join('addresses', 'orders.address_id', '=', 'addresses.id')
        // ->join('users', 'orders.user_id', '=', 'users.id');
